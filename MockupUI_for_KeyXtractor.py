...
if st.session_state.page == "Home":
    ...
    st.title("About")
    st.markdown("KeyXtractor is a cutting-edge tool developed to streamline the extraction of crucial information from a variety of document formats. Our platform leverages advanced Natural Language Processing (NLP) techniques to sift through PDFs, text files, and Word documents, providing users with succinct summaries and key insights. With a focus on efficiency and accuracy, KeyXtractor assists users in distilling large volumes of text into concise, meaningful content, enhancing productivity and decision-making processes. Developed by a dedicated team of learners(Team DER-YELL), KeyXtractor represents a commitment to innovation and excellence in the field of document analysis and summarization.", spacing=2.0)
